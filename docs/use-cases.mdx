...
const kb = await createContextWindow({
...
```typescript
const research = await createContextWindow({
...
```typescript
const market = await createContextWindow({
...
```typescript
const studyAssistant = await createContextWindow({
...
```typescript
const legal = await createContextWindow({
  indexName: "contracts",
...
```typescript
const policies = await createContextWindow({
...
```typescript
const archive = await createContextWindow({
...
```typescript
const medical = await createContextWindow({
...
```typescript
const properties = await createContextWindow({
...
```typescript
const recipes = await createContextWindow({
